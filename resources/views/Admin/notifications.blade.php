    ...
    <div class="kt-mainpanel">
      <div class="kt-pagetitle">
        <div class="row row-sm" style="width: 100%">
          <div class="col-lg-8"><h5>Notification</h5></div>
              ...
              <tbody>
               @foreach($Notifications as $Notification)
                <tr>
                  ...
                  <td style="text-align: center;"><a href="{{url('/admin/viewNotification/'.$Notification->id)}}"><i class="fa fa-eye fa-2x" style="color: green;"></i></a> &nbsp;</td>
                  <td></td>
                </tr>
               @endforeach
