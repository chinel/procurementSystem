         ...
         <div class="col-xl-1"></div>
          <div class="col-xl-8 mg-t-25 mg-xl-t-0">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-5" style="border: 0px;">
              <h2  style="text-align: center;">Add Request</h2>
              <br>
              <form action="{{url('/admin/addRequest')}}" data-parsley-validate method="post" enctype="multipart/form-data">

                <input type="hidden" name="_token" value="{{csrf_token()}}">
              <div class="row row-xs">
                <label class="col-sm-5 form-control-label"> Procurement Title <span class="tx-danger">*</span></label>
                <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" placeholder="Procurement title" required name="title">
                </div>
              </div><!-- row -->
              ...
              <input type="text" class="form-control fc-datepicker" placeholder="Open date" required="" name="open_date">
            </div>
                            </div>
              </div>
                <div class="row row-xs mg-t-20">
                ...
                <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                  <div class="input-group">
              <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
              <input type="text" class="form-control fc-datepicker" placeholder="Close date" required="" name="close_date">
            </div>
                            </div>
              </div>
              ...
              <div class="row row-xs mg-t-20">
                ...
                <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                  <textarea rows="6" class="form-control" placeholder="Additional Details 20 Chars" name="comments" required=""></textarea>
                </div>
              </div>
