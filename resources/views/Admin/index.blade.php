          ...
          <div class="col-lg-12">
            <div class="row row-sm">
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body pd-b-0">
                    <h6 class="card-body-title tx-12 tx-spacing-2 mg-b-20 tx-success">Total No. of bids made</h6>
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body pd-b-0">
                    <h6 class="card-body-title tx-12 tx-spacing-2 mg-b-20 tx-danger">Total No. of pending bids</h6>
                    <h2 class="tx-lato tx-inverse">{{$TotalPendingbids}}</h2>
                  </div><!-- card-body -->
