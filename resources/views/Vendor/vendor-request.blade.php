   ...
   <!-- ##### SIDEBAR LOGO ##### -->
    ...
    <div class="kt-headpanel">
      ...
      <div class="kt-headpanel-right">
        ...
        s<a href="{{url('auth/logout')}}" class="nav-link nav-link-profile">
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              @foreach($allRequests as $allRequest)
                <tr>
                  ...
                  <td style="text-align: center;"><a href="{{url('/vendor/viewRequest/'. $allRequest->id)}}"><i class="fa fa-eye fa-2x" style="color: green;"></i></a> &nbsp; </td>
                  <td></td>
                </tr>
              @endforeach
